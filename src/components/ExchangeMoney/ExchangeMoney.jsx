...
import { updateUserCurrencies } from "../../store/user/userReducer";
                ...
                <div className={style.innerBlock}>
                    ...
                    <div className={style.form}>
                        <div className={style.group}>
                            ...
                            <select className={style.select} ref={selectFrom}>
                                {currencies ? (
                                    currencies.map((elem) => (
                        ...
                        <div className={style.group}>
                            ...
                            <select className={style.select} ref={selectTo}>
                                {currencies ? (
                                    currencies.map((elem) => (
                                        <option key={elem} value={elem}>
                                            {elem}
                    ...
                    <div className={style.infoGroup}>
                        <p
                            className={
                                exchange
                                    ? style.exchangeMessageOk
                                    : style.exchangeMessageError
                            }
                        >
                            {exchangeMessage}
                        </p>
            ...
            <div className={style.balance}>
                ...
                <ul>
                    {userCurrencies.length > 0 ? (
                        userCurrencies.map((elem) => {
                            if (elem.amount > 0) {
                                return (
                                    <li
                                        key={elem.code}
                                        className={style.userCurrenciesLi}
                                    >
